...
const ConverterDisplay: React.FC<ConverterDisplayProps> = ({
  ...
  if (amount.toString().length > 8 || convertedAmount.toString().length > 8) {
    ...
    displayedConvertedAmount = parseFloat(convertedAmount.toString())
      .toExponential(4)
      .toString();
  } else {
  ...
  return (
    <Box textAlign="right" paddingRight="1rem" paddingTop="1rem">
      <Text fontSize="2xl" fontWeight="bold" color="rgb(15,215,245)">
